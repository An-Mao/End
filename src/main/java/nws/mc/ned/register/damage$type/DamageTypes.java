...
public class DamageTypes {
    ...
    public static final ResourceKey<DamageType> GONG =
            ResourceKey.create(Registries.DAMAGE_TYPE, ResourceLocation.fromNamespaceAndPath(NED.MOD_ID, "gong"));
    public static final ResourceKey<DamageType> SHANG =
            ResourceKey.create(Registries.DAMAGE_TYPE, ResourceLocation.fromNamespaceAndPath(NED.MOD_ID, "shang"));

    public static final ResourceKey<DamageType> JUE =
            ResourceKey.create(Registries.DAMAGE_TYPE, ResourceLocation.fromNamespaceAndPath(NED.MOD_ID, "jue"));

    public static final ResourceKey<DamageType> ZHI =
            ResourceKey.create(Registries.DAMAGE_TYPE, ResourceLocation.fromNamespaceAndPath(NED.MOD_ID, "zhi"));

    public static final ResourceKey<DamageType> YU =
            ResourceKey.create(Registries.DAMAGE_TYPE, ResourceLocation.fromNamespaceAndPath(NED.MOD_ID, "yu"));
